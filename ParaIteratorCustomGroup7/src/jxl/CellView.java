...
public final class CellView {
	/**
	 * The dimension for the associated group of cells. For columns this will be
	 * width in characters, for rows this will be the height in points This
	 * attribute is deprecated in favour of the size attribute
	 */
	private int dimension;

	/**
	 * The size for the associated group of cells. For columns this will be
	 * width in characters multiplied by 256, for rows this will be the height
	 * in points
	 */
	private int size;
	 ...
	 *
	 * @param d
	 *            the width of the column in characters multiplied by 256, or
	 *            the height of the row in 1/20ths of a point
	 */
	...
	/**
	 * Gets the width of the column in characters or the height of the row in
	 * 1/20ths
	 *
	 ...
	 *
	 * @return the format for the column/row, or NULL if no format was specified
	 */
	 ...
	 *
	 * @return TRUE if the deprecated methods were used to set the size, FALSE
	 *         otherwise
	 */
	...
	/**
	 * Accessor for the autosize flag NOTE: use of the autosize function is very
	 * processor intensive, so use with care
	 *
