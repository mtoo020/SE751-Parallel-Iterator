...
/**
 * Exposes some cell reference helper methods to the public interface. This
 * class merely delegates to the internally used reference helper
 */
public final class CellReferenceHelper {
	 ...
	 *            the column number
	 * @param colabs
	 *            TRUE if the column reference is absolute
	 * @param row
	 *            the row number
	 * @param rowabs
	 *            TRUE if the row reference is absolute
	 * @param buf
	 *            the string buffer
	 */
	public static void getCellReference(int column, boolean colabs, int row,
			boolean rowabs, StringBuffer buf) {
		jxl.biff.CellReferenceHelper.getCellReference(column, colabs, row,
				rowabs, buf);
	}
	...
	/**
	 * Gets the fully qualified cell reference given the column, row external
	 * sheet reference etc
	 *
	 * @param sheet
	 *            the sheet index
	...
	public static void getCellReference(int sheet, int column, int row,
		...
		jxl.biff.CellReferenceHelper.getCellReference(sheet, column, row,
	 ...
	 *            the column
	 * @param colabs
	 *            TRUE if the column is an absolute reference
	 * @param row
	 *            the row
	 * @param rowabs
	 *            TRUE if the row is an absolute reference
	 * @param workbook
	 *            the workbook
	 * @param buf
	 *            the string buffer
	 */
	public static void getCellReference(int sheet, int column, boolean colabs,
			int row, boolean rowabs, Workbook workbook, StringBuffer buf) {
		jxl.biff.CellReferenceHelper.getCellReference(sheet, column, colabs,
				row, rowabs, (jxl.biff.formula.ExternalSheet) workbook, buf);
	}
	...
	public static String getCellReference(int sheet, int column, int row,
			Workbook workbook) {
		return jxl.biff.CellReferenceHelper.getCellReference(sheet, column,
				row, (jxl.biff.formula.ExternalSheet) workbook);
	}
