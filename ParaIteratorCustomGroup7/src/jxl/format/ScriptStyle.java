...
/**
 * Enumeration class which contains the various script styles available within
 * the standard Excel ScriptStyle palette
 * 
 */
public final class ScriptStyle {
	...
	/**
	 * The display string for the script style. Used when presenting the format
	 * information
	 */
	...
	/**
	 * Gets the value of this style. This is the value that is written to the
