...
/**
 * Enumeration class which contains the various patterns available within the
 * standard Excel pattern palette
 */
public/* final */class Pattern {
	...
	/**
	 * Gets the value of this pattern. This is the value that is written to the
