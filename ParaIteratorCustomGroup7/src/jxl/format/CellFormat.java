...
public interface CellFormat {
	...
	/**
	 * Gets the colour for the given cell border If a border type of ALL or NONE
	 * is specified, then a line style of NONE is returned If the specified cell
	 * does not have an associated line style, then the colour the line would be
	 * is still returned
	 *
	 * @param border
	 *            the cell border we are interested in
