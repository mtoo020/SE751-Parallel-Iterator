...
public final class Orientation {
	...
	/**
	 * Cells with this specified orientation have their data presented
	 * vertically
	 */
	public static Orientation VERTICAL = new Orientation(0xff, "vertical");
	/**
	 * Cells with this specified orientation will have their data presented with
	 * a rotation of 90 degrees upwards
	 */
	public static Orientation PLUS_90 = new Orientation(90, "up 90");
	/**
	 * Cells with this specified orientation will have their data presented with
	 * a rotation of 90 degrees downwards
	 */
	public static Orientation MINUS_90 = new Orientation(180, "down 90");
	/**
	 * Cells with this specified orientation will have their data presented with
	 * a rotation 45 degrees upwards
	 */
	public static Orientation PLUS_45 = new Orientation(45, "up 45");
	/**
	 * Cells with this specified orientation will have their data presented with
	 * a rotation 45 degrees downwards
	 */
