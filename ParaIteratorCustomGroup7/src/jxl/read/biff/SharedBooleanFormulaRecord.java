...
public class SharedBooleanFormulaRecord extends BaseSharedFormulaRecord
	...
	private static Logger logger = Logger
			.getLogger(SharedBooleanFormulaRecord.class);

	/**
	 * The boolean value of this cell. If this cell represents an error, this
	 * will be false
	 */
	 ...
	 *            the sheet
	 */
	public SharedBooleanFormulaRecord(Record t, File excelFile, boolean v,
	 ...
	 *
	 * @return TRUE if this cell contains TRUE, FALSE if it contains FALSE or an
	 *         error code
	 */
