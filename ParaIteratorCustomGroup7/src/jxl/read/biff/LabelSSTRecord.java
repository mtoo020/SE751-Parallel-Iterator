...
class LabelSSTRecord extends CellValue implements LabelCell {
	...
	/**
	 * Constructor. Retrieves the index from the raw data and looks it up in the
	 * shared string table
	 *
	 * @param stringTable
	 ...
	 *            the sheet
	 */
	public LabelSSTRecord(Record t, SSTRecord stringTable,
			FormattingRecords fr, SheetImpl si) {
		super(t, fr, si);
