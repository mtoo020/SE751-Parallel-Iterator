 ...
 * "optimization"
 */
public class SharedErrorFormulaRecord extends BaseSharedFormulaRecord implements
		ErrorCell, FormulaData, ErrorFormulaCell {
	/**
	 * The logger
	 */
	private static Logger logger = Logger
			.getLogger(SharedErrorFormulaRecord.class);
	 ...
	 *            the sheet
	 */
	public SharedErrorFormulaRecord(Record t, File excelFile, int ec,
	 ...
	 * does not represent an error, then it returns 0. Always use the method
	 * isError() to determine this prior to calling this method
	 *
	...
	public String getContents() {
		...
		return error != FormulaErrorCode.UNKNOWN ? error.getDescription()
				: "ERROR " + errorCode;
	}
