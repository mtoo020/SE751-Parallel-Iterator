 ...
 */
class DateFormulaRecord extends DateRecord implements DateCell, FormulaData,
		DateFormulaCell {
	/**
	 ...
	 *
	 * @param t
	 *            the basic number formula record
	 * @param fr
	 ...
	 *            the name table
	 * @param nf
	 *            flag indicating whether the 1904 date system is in use
	 * @param si
	 *            the sheet
	 */
	public DateFormulaRecord(NumberFormulaRecord t, FormattingRecords fr,
			ExternalSheet es, WorkbookMethods nt, boolean nf, SheetImpl si)
	...
	public String getFormula() throws FormulaException {
		// Note that the standard information was lopped off by the
		// NumberFormula
