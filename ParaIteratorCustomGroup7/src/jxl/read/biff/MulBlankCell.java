...
/**
 * A blank cell value, initialized indirectly from a multiple biff record rather
 * than directly from the binary data
 */
class MulBlankCell implements Cell, CellFeaturesAccessor {
	...
	/**
	 * A flag to indicate whether this object's formatting things have been
	 * initialized
	 */
	 ...
	 *            the sheet
	 */
	public MulBlankCell(int r, int c, int xfi, FormattingRecords fr,
			SheetImpl si) {
		row = r;
		column = c;
		xfIndex = xfi;
