 ...
 * "optimization"
 */
public class SharedDateFormulaRecord extends BaseSharedFormulaRecord implements
		DateCell, FormulaData, DateFormulaCell {
	/**
	 * Re-use the date record to handle all the formatting information and date
	 * calculations
	 */
	...
	public SharedDateFormulaRecord(SharedNumberFormulaRecord nfr,
			FormattingRecords fr, boolean nf, SheetImpl si, int pos) {
		super(nfr.getRecord(), fr, nfr.getExternalSheet(), nfr.getNameTable(),
				si, pos);
	...
	public byte[] getFormulaData() throws FormulaException {
		...
		FormulaParser fp = new FormulaParser(getTokens(), this,
				getExternalSheet(), getNameTable(), getSheet().getWorkbook()
						.getSettings());
		fp.parse();
	...
	/**
	 * Gets the DateFormat used to format the cell. This will normally be the
	 * format specified in the excel spreadsheet, but in the event of any
