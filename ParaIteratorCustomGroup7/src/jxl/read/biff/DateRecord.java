...
class DateRecord implements DateCell, CellFeaturesAccessor {
	...
	/**
	 * A flag to indicate whether this objects formatting things have been
	 * initialized
	 */
	 ...
	 *
	 * @param num
	 *            the numerical representation of this
	 * @param xfi
	 *            the java equivalent of the excel date format
	 * @param fr
	 *            the formatting records
	 * @param nf
	 *            flag indicating whether we are using the 1904 date system
	 * @param si
	 *            the sheet
	 */
	public DateRecord(NumberCell num, int xfi, FormattingRecords fr,
		...
		// called the 29th Feb, 1900 - but in actual fact this was not a leap
		// year.
