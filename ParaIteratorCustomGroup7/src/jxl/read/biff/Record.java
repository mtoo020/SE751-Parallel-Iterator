...
public final class Record {
	...
	/**
	 * In the case of dodgy records, this method may be called to forcibly set
	 * the type in order to continue processing
	 *
	 * @param t
	 *            the forcibly overridden type
	 */
	void setType(Type t) {
		type = t;
	}
