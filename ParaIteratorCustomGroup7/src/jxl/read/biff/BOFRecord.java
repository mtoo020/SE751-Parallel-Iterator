...
public class BOFRecord extends RecordData {
	...
	/**
	 * Interrogates the substream to see if it is the commencement of a
	 * worksheet
	 *
	...
	/**
	 * Gets the length of the data portion of this record Used to adjust when
	 * reading sheets which contain just a chart
	 * 
