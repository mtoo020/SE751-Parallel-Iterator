 ...
 * of that spreadsheet which contains the same data. If the spreadsheet read in
 * is the spreadsheet called jxlrwtest.xls (provided with the distribution) then
 * this class will modify certain fields in the copy of that spreadsheet. This
 * is illustrating that it is possible to read in a spreadsheet, modify a few
 * values, and write it under a new name.
 */
