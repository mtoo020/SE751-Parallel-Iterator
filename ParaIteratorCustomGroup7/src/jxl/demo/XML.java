...
public class XML {
	 ...
	 * @param out
	 *            The output stream to which the XML values are written
	 * @param enc
						...
						if ((row[j].getType() != CellType.EMPTY)
							...
							if (row[j].getCellFormat() != null) {
								...
								if (format.getBorder(Border.TOP) != BorderLineStyle.NONE
									...
									bw.write("          <border top=\""
											+ format.getBorder(Border.TOP)
													.getDescription() + "\"");
									bw.newLine();
									bw.write("                  bottom=\""
											+ format.getBorder(Border.BOTTOM)
													.getDescription() + "\"");
									bw.newLine();
									bw.write("                  left=\""
											+ format.getBorder(Border.LEFT)
													.getDescription() + "\"");
									bw.newLine();
									bw.write("                  right=\""
											+ format.getBorder(Border.RIGHT)
													.getDescription() + "\"");
									bw.write(" />");
									bw.newLine();
								}
								...
								if (!format.getFormat().getFormatString()
										.equals("")) {
