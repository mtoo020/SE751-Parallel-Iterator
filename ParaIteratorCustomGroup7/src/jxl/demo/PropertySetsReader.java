...
class PropertySetsReader {
	...
	public PropertySetsReader(java.io.File file, String propertySet,
			OutputStream os) throws IOException, BiffException {
	...
	void displaySets() throws IOException {
		...
		for (int i = 0; i < numSets; i++) {
			BaseCompoundFile.PropertyStorage ps = compoundFile
					.getPropertySet(i);
	 ...
	 */
	void displayPropertySet(String ps, OutputStream os) throws IOException,
			BiffException {
