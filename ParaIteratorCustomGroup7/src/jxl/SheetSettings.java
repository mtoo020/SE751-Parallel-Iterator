 ...
 * properties which are associated with a particular worksheet, such as headers
 * and footers, page orientation etc.
 */
public final class SheetSettings {
	...
	/**
	 * The zoom factor used when viewing. Note the difference between this and
	 * the scaleFactor which is used when printing
	 */
	...
	/**
	 * Indicates whether to fit the print to the pages or scale the output This
	 * field is manipulated indirectly by virtue of the setFitWidth/Height
	 * methods
	 */
	...
	public SheetSettings(SheetSettings copy, Sheet s) {
		...
		if (copy.printArea != null) {
			printArea = new SheetRangeImpl(sheet, copy.getPrintArea()
					.getTopLeft().getColumn(), copy.getPrintArea().getTopLeft()
					.getRow(),
					copy.getPrintArea().getBottomRight().getColumn(), copy
							.getPrintArea().getBottomRight().getRow());
		}

		if (copy.printTitlesRow != null) {
			printTitlesRow = new SheetRangeImpl(sheet, copy.getPrintTitlesRow()
					.getTopLeft().getColumn(), copy.getPrintTitlesRow()
					.getTopLeft().getRow(), copy.getPrintTitlesRow()
					.getBottomRight().getColumn(), copy.getPrintTitlesRow()
					.getBottomRight().getRow());
		}

		if (copy.printTitlesCol != null) {
			printTitlesCol = new SheetRangeImpl(sheet, copy.getPrintTitlesCol()
					.getTopLeft().getColumn(), copy.getPrintTitlesCol()
					.getTopLeft().getRow(), copy.getPrintTitlesCol()
					.getBottomRight().getColumn(), copy.getPrintTitlesCol()
					.getBottomRight().getRow());
		}
	}
	...
	/**
	 * Sets the number of pages widthwise which this sheet should be printed
	 * into
	 *
	 * @param fw
	 *            the number of pages
	 ...
	 * to the on screen view) with scale factor (which refers to the scale
	 * factor when printing)
	 *
	...
	/**
	 * Sets the zoom factor. Do not confuse zoom factor (which relates to the on
	 * screen view) with scale factor (which refers to the scale factor when
	 * printing)
	 *
	 * @param zf
	...
	/**
	 * Accessor for the page break preview mangificaton factor. Do not confuse
	 * zoom factor or scale factor
	 *
	...
	/**
	 * Accessor for the page break preview magnificaton factor. Do not confuse
	 * zoom factor or scale factor
	 *
	 * @param f
	...
	/**
	 * Accessor for the nomral view magnificaton factor. Do not confuse zoom
	...
	/**
	 * Accessor for the normal magnificaton factor. Do not confuse zoom factor
	 * or scale factor
	 *
	 * @param f
	 *            the page break preview magnification as a percentage
	 ...
	 *
	 * @param auto
	 *            - TRUE to automatically calculate the formulas, FALSE
	 *            otherwise
	 */
	 ...
	 *
	 * @return TRUE if formulas are calculated automatically, FALSE if they are
	 *         calculated manually
	 */
	 ...
	 *
	 * @return TRUE if formulas are calculated before the sheet is saved, FALSE
	 *         otherwise
	 */
	 ...
	 *
	 * @param firstCol
	 *            the first column of the print area
	 * @param firstRow
	 *            the first row of the print area
	 * @param lastCol
	 *            the last column of the print area
	 * @param lastRow
	 *            the last row of the print area
	 */
	public void setPrintArea(int firstCol, int firstRow, int lastCol,
			int lastRow) {
		printArea = new SheetRangeImpl(sheet, firstCol, firstRow, lastCol,
				lastRow);
	}
	 ...
	 *
	 * @param firstRow
	 *            the first row of the print row titles
	 * @param lastRow
	 *            the last row of the print row titles
	 * @param firstCol
	 *            the first column of the print column titles
	 * @param lastCol
	 *            the last column of the print column titles
	 */
	public void setPrintTitles(int firstRow, int lastRow, int firstCol,
			int lastCol) {
	 ...
	 *
	 * @param firstRow
	 *            the first row of the print titles
	 * @param lastRow
	 *            the last row of the print titles
	 */
	public void setPrintTitlesRow(int firstRow, int lastRow) {
		printTitlesRow = new SheetRangeImpl(sheet, 0, firstRow, 255, lastRow);
	}
	...
	public void setPrintTitlesCol(int firstCol, int lastCol) {
		printTitlesCol = new SheetRangeImpl(sheet, firstCol, 0, lastCol, 65535);
	}

	/**
	 * Accessor for the print row titles
	 *
	 * @return the print row titles, or NULL if one is not defined for this
	 *         sheet
	 */
