 ...
 *
 * Hyperlinks may apply to a range of cells; in such cases the methods getRow
 * and getColumn return the cell at the top left of the range the hyperlink
 * refers to. Hyperlinks have no specific cell format information applied to
 * them, so the getCellFormat method will return null
 */
