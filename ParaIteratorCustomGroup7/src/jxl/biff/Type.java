...
public final class Type {
	...
	/**
	 * Constructor Sets the biff value and adds this type to the array of all
	 * types
	 *
	 * @param v
	 *            the biff code for the type
	 */
	private Type(int v) {
		value = v;
	...
	/**
	 * Used to create an arbitrary record type. This method is only used during
	 * bespoke debugging process. The creation of an arbitrary type does not add
	 * it to the static list of known types
	 */
