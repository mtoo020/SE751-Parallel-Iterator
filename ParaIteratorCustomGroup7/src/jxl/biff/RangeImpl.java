 ...
 * information, and when the time comes, it interrogates the workbook for the
 * object. This does not keep handles to the objects for performance reasons, as
 * this could impact garbage collection on larger spreadsheets
 */
public class RangeImpl implements Range {
	...
	public Cell getTopLeft() {
		...
		if (column1 < s.getColumns() && row1 < s.getRows()) {
	...
	public Cell getBottomRight() {
		...
		if (column2 < s.getColumns() && row2 < s.getRows()) {
