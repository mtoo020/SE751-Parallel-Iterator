...
public class PaletteRecord extends WritableRecordData {
	...
	/**
	 * A dirty flag indicating that this palette has been tampered with in some
	 * way
	 */
	...
	public PaletteRecord() {
		...
		for (int i = 0; i < colours.length; i++) {
			Colour c = colours[i];
			setColourRGB(c, c.getDefaultRGB().getRed(), c.getDefaultRGB()
					.getGreen(), c.getDefaultRGB().getBlue());
		}
	}
