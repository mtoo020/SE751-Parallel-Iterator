...
public class FormulaErrorCode {
	...
	public static final FormulaErrorCode UNKNOWN = new FormulaErrorCode(0xff,
			"?");
	public static final FormulaErrorCode NULL = new FormulaErrorCode(0x0,
			"#NULL!");
	public static final FormulaErrorCode DIV0 = new FormulaErrorCode(0x7,
			"#DIV/0!");
	public static final FormulaErrorCode VALUE = new FormulaErrorCode(0xf,
			"#VALUE!");
	public static final FormulaErrorCode REF = new FormulaErrorCode(0x17,
			"#REF!");
	public static final FormulaErrorCode NAME = new FormulaErrorCode(0x1d,
			"#NAME?");
