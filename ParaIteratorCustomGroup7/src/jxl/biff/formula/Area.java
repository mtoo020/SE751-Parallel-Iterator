...
class Area extends Operand implements ParsedThing {
	...
	byte[] getBytes() {
		...
		data[0] = !useAlternateCode() ? Token.AREA.getCode() : Token.AREA
				.getCode2();
	 ...
	 */
	protected void setRangeData(int colFirst, int colLast, int rwFirst,
			int rwLast, boolean colFirstRel, boolean colLastRel,
	 ...
	 * another sheet are warned appropriately Does nothing here
	 */
