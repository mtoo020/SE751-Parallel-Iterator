...
/**
 * An enumeration detailing the Excel parsed tokens A particular token may be
 * associated with more than one token code
 */
class Token {
	/**
	...
	/**
	 * Gets the reference token code for the specified token. This is always the
	 * first on the list
	 * 
	 * @return the token code. This is the first item in the array
	 */
	...
	/**
	 * Gets the an alternative token code for the specified token Used for
	 * certain types of volatile function
	 * 
	...
	/**
	 * Gets the value token code for the specified token. This is always the
