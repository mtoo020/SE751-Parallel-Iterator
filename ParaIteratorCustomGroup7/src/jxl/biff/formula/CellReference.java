...
class CellReference extends Operand implements ParsedThing {
	...
	/**
	 * The cell containing the formula. Stored in order to determine relative
	 * cell values
	 */
	 ...
	 *
	 * @param buf
	 *            the string buffer to populate
	 */
	public void getString(StringBuffer buf) {
		CellReferenceHelper.getCellReference(column, !columnRelative, row,
				!rowRelative, buf);
	}
	...
	byte[] getBytes() {
		...
		data[0] = !useAlternateCode() ? Token.REF.getCode() : Token.REF
				.getCode2();
	 ...
	 * another sheet are warned appropriately Flags the formula as invalid Does
	 * nothing here
	 */
