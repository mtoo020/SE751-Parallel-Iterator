...
class Area3d extends Operand implements ParsedThing {
	...
	public void getString(StringBuffer buf) {
		CellReferenceHelper.getCellReference(sheet, columnFirst, rowFirst,
				workbook, buf);
		buf.append(':');
	 ...
	 *            the last row
	 * @param colFirstRel
	 *            flag indicating whether the first column is relative
	 * @param colLastRel
	 *            flag indicating whether the last column is relative
	 * @param rowFirstRel
	 *            flag indicating whether the first row is relative
	 * @param rowLastRel
	 *            flag indicating whether the last row is relative
	 */
	protected void setRangeData(int sht, int colFirst, int colLast,
			int rwFirst, int rwLast, boolean colFirstRel, boolean colLastRel,
