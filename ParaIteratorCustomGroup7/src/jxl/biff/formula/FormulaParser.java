...
/**
 * Parses the formula passed in (either as parsed strings or as a string) into a
...
public class FormulaParser {
	...
	public FormulaParser(byte[] tokens, Cell rt, ExternalSheet es,
			WorkbookMethods nt, WorkbookSettings ws) throws FormulaException {
		// A null workbook bof means that it is a writable workbook and
		// therefore
		// must be biff8
	...
	public FormulaParser(String form, ExternalSheet es, WorkbookMethods nt,
			WorkbookSettings ws) {
		parser = new StringFormulaParser(form, es, nt, ws, ParseContext.DEFAULT);
	}
