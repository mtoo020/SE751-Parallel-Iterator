...
/**
 * A "holding" token for a range separator. This token gets instantiated when
 * the lexical analyzer can't distinguish a range cleanly, eg in the case where
 * where one of the identifiers of the range is a formula
 */
