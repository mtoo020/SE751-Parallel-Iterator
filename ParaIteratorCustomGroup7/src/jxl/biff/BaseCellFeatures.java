...
public class BaseCellFeatures {
	...
	public static final ValidationCondition BETWEEN = new ValidationCondition(
			DVParser.BETWEEN);
	public static final ValidationCondition NOT_BETWEEN = new ValidationCondition(
			DVParser.NOT_BETWEEN);
	public static final ValidationCondition EQUAL = new ValidationCondition(
			DVParser.EQUAL);
	public static final ValidationCondition NOT_EQUAL = new ValidationCondition(
			DVParser.NOT_EQUAL);
	public static final ValidationCondition GREATER_THAN = new ValidationCondition(
			DVParser.GREATER_THAN);
	public static final ValidationCondition LESS_THAN = new ValidationCondition(
			DVParser.LESS_THAN);
	public static final ValidationCondition GREATER_EQUAL = new ValidationCondition(
			DVParser.GREATER_EQUAL);
	public static final ValidationCondition LESS_EQUAL = new ValidationCondition(
			DVParser.LESS_EQUAL);
	 ...
	 * @param width
	 *            the width of the comment box in cells
	 */
	...
	public void removeComment() {
		...
		if (commentDrawing != null) {
			// do not call DrawingGroup.remove() because comments are not
			// present
	...
	/**
	 * Internal function which removes any data validation, including shared
	 * ones, if present. This is called from WritableSheetImpl in response to a
	 * call to removeDataValidation
	 */
	 ...
	 *
	 * @return TRUE if this has a data validation associated with it, FALSE
	 *         otherwise
	 */
