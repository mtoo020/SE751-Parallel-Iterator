...
/**
 * An interface containing some common workbook methods. This so that objects
 * which are re-used for both readable and writable workbooks can still make the
 * same method calls on a workbook
 */
