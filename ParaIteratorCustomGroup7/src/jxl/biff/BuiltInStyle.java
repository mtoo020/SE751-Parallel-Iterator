...
/**
 * Represents a built in, rather than a user defined, style. This class is used
 * by the FormattingRecords class when writing out the hard* coded styles
 */
class BuiltInStyle extends WritableRecordData {
	 ...
	 *            the xf index of this style
	 * @param sn
	 *            the style number of this style
	 */
	...
	/**
	 * Abstract method implementation to get the raw byte data ready to write
	 * out
	 *
