...
public class ObjRecord extends WritableRecordData {
	...
	public static final ObjType MSOFFICEDRAWING = new ObjType(0x1e,
			"MS Office Drawing");
	public static final ObjType FORMCONTROL = new ObjType(0x14,
			"Form Combo Box");
	...
	private byte[] getPictureData() {
		int dataLength = COMMON_DATA_LENGTH + CLIPBOARD_FORMAT_LENGTH
				+ PICTURE_OPTION_LENGTH + END_LENGTH;
		int pos = 0;
	...
	private byte[] getNoteData() {
		int dataLength = COMMON_DATA_LENGTH + NOTE_STRUCTURE_LENGTH
				+ END_LENGTH;
		int pos = 0;
		byte[] data = new byte[dataLength];
	...
	private byte[] getComboBoxData() {
		int dataLength = COMMON_DATA_LENGTH + COMBOBOX_STRUCTURE_LENGTH
				+ END_LENGTH;
		int pos = 0;
		byte[] data = new byte[dataLength];
