...
public class Chart implements ByteData, EscherStream {
	 ...
	 *
	 * @param mso
	 *            a <code>MsoDrawingRecord</code> value
	 * @param obj
	 *            an <code>ObjRecord</code> value
	 * @param dd
	 *            the drawing data
	 * @param sp
	 ...
	 *            the workbook settings
	 */
	public Chart(MsoDrawingRecord mso, ObjRecord obj, DrawingData dd, int sp,
			int ep, File f, WorkbookSettings ws) {
	 ...
	 */
	public void rationalize(IndexMapping xfMapping, IndexMapping fontMapping,
