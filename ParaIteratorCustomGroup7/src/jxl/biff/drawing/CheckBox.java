...
/**
 * Contains the various biff records used to copy a CheckBox (from the Form
...
public class CheckBox implements DrawingGroupObject {
	...
	public EscherContainer getSpContainer() {
		...
		ClientAnchor clientAnchor = new ClientAnchor(column, row, column + 1,
				row + 1, 0x1);
	...
	public void writeAdditionalRecords(File outputFile) throws IOException {
		...
		ObjRecord objrec = new ObjRecord(objectId, ObjRecord.CHECKBOX);
