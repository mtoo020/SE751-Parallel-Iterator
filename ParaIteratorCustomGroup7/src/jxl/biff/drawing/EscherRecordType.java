...
final class EscherRecordType {
	 ...
	 * @param val
	 *            the escher record value
	 * @return the type corresponding to val, or UNKNOWN if a match could not be
	 *         found
	 */
	...
	public static final EscherRecordType DGG_CONTAINER = new EscherRecordType(
			0xf000);
	public static final EscherRecordType BSTORE_CONTAINER = new EscherRecordType(
			0xf001);
	public static final EscherRecordType DG_CONTAINER = new EscherRecordType(
			0xf002);
	public static final EscherRecordType SPGR_CONTAINER = new EscherRecordType(
			0xf003);
	public static final EscherRecordType SP_CONTAINER = new EscherRecordType(
			0xf004);
	...
	public static final EscherRecordType CLIENT_ANCHOR = new EscherRecordType(
			0xf010);
	public static final EscherRecordType CLIENT_DATA = new EscherRecordType(
			0xf011);
	public static final EscherRecordType CLIENT_TEXT_BOX = new EscherRecordType(
			0xf00d);
	public static final EscherRecordType SPLIT_MENU_COLORS = new EscherRecordType(
			0xf11e);
}
