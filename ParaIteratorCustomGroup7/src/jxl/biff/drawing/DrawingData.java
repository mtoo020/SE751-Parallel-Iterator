...
/**
 * Class used to concatenate all the data for the various drawing objects into
...
public class DrawingData implements EscherStream {
	...
	/**
	 * Adds the data to the array without incrementing the drawing number. This
	 * is used by comments, which for some bizarre and inexplicable reason split
	 * out the data
	 *
	 * @param data
	 *            the data to add
