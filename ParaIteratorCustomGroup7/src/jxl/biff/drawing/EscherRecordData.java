...
/**
 * A single record from an Escher stream. Basically this a container for the
 * header data for each Escher record
 */
final class EscherRecordData {
	...
	/**
	 * Sets whether or not this is a container - called when writing out an
	 * escher stream
	 *
	 * @param c
	...
	/**
	 * Adds the 8 byte header data on the value data passed in, returning the
	 * modified data
	 *
	 * @param d
	 *            the value data
