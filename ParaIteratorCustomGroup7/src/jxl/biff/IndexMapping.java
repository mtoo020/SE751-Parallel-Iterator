...
/**
 * This class is a wrapper for a list of mappings between indices. It is used
 * when removing duplicate records and specifies the new index for cells which
 * have the duplicate format
 */
public final class IndexMapping {
	 ...
	 *
	 * @param size
	 *            the number of index numbers to be mapped
	 */
