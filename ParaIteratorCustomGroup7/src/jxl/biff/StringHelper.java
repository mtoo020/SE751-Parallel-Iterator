...
public final class StringHelper {
	 ...
	 *
	 * @param pos
	 *            the position at which to place the converted data
	 * @param s
	 *            the string to convert
	 * @param d
	 ...
	 *
	 * @param pos
	 *            the position at which to insert the converted data
	 * @param s
	 *            the string to convert
	 * @param d
	...
	/**
	 * Gets a string from the data array using the character encoding for this
	 * workbook
	 *
	 * @param pos
	 *            The start position of the string
	 * @param length
	 *            The number of bytes to transform into a string
	 * @param d
	 *            The byte data
	 * @param ws
	 ...
	 *            The start position of the string
	 * @param length
	 *            The number of characters to be converted into a string
	 * @param d
	 *            The byte data
	...
	/**
	 * Replaces all instances of search with replace in the input. Even though
	 * later versions of java can use string.replace() this is included Java 1.2
	 * compatibility
	 *
	 * @param input
	 *            the format string
	 ...
	 */
	public static final String replace(String input, String search,
			String replace) {
		String fmtstr = input;
