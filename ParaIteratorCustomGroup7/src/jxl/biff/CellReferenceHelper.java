...
/**
 * A helper to transform between excel cell references and sheet:column:row
 * notation Because this function will be called when generating a string
 * representation of a formula, the cell reference will merely be appened to the
 * string buffer instead of returning a full blooded string, for performance
 * reasons
 */
public final class CellReferenceHelper {
	 ...
	 *            the column number
	 * @param buf
	 *            the string buffer in which to write the column letter
	 */
	...
	public static void getCellReference(int sheet, int column, boolean colabs,
			int row, boolean rowabs, ExternalSheet workbook, StringBuffer buf) {
