...
/**
 * The interface implemented by the various number and date format styles. The
 * methods on this interface are called internally when generating a spreadsheet
 */
