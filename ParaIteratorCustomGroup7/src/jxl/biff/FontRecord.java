...
public class FontRecord extends WritableRecordData implements Font {
	 ...
	 *            the name
	 * @param it
	 *            italicised indicator
	 * @param ss
	 *            the script style
	 * @param ci
	 *            the colour index
	 */
	protected FontRecord(String fn, int ps, int bold, boolean it, int us,
			int ci, int ss) {
		super(Type.FONT);
		boldWeight = bold;
		underlineStyle = us;
	...
	public boolean equals(Object o) {
		...
		if (pointHeight == font.pointHeight && colourIndex == font.colourIndex
				&& boldWeight == font.boldWeight
				&& scriptStyle == font.scriptStyle
				&& underlineStyle == font.underlineStyle
				&& italic == font.italic && struckout == font.struckout
				&& fontFamily == font.fontFamily
				&& characterSet == font.characterSet && name.equals(font.name)) {
			return true;
		}
	 ...
	 *
	 * @param os
	 *            TRUE if the font is struck out, false otherwise
	 */
