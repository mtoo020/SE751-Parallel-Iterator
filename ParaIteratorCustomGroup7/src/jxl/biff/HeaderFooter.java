...
/**
 * Class which represents an Excel header or footer. Information for this class
 * came from Microsoft Knowledge Base Article 142136 (previously Q142136).
 *
 * This class encapsulates three internal structures representing the header or
 * footer contents which appear on the left, right or central part of the page
 */
public abstract class HeaderFooter {
	...
	protected static class Contents {
		...
		/**
		 * Constructor used when reading worksheets. The string contains all the
		 * formatting (but not alignment characters
		 *
		 * @param s
		 *            the format string
		 */
		...
		/**
		 * Retrieves a <code>String</code>ified version of this object
		 *
		...
		/**
		 * Turns bold printing on or off. Bold printing is initially off. Text
		 * subsequently appended to this object will be bolded until this method
		 * is called again.
		 */
		...
		/**
		 * Turns underline printing on or off. Underline printing is initially
		 * off. Text subsequently appended to this object will be underlined
		...
		/**
		 * Turns italics printing on or off. Italics printing is initially off.
		 * Text subsequently appended to this object will be italicized until
		...
		/**
		 * Turns strikethrough printing on or off. Strikethrough printing is
		 * initially off. Text subsequently appended to this object will be
		 * striked out until this method is called again.
		 */
		 ...
		 * is initially off. Text subsequently appended to this object will be
		 * double-underlined until this method is called again.
		 */
		...
		/**
		 * Turns superscript printing on or off. Superscript printing is
		 * initially off. Text subsequently appended to this object will be
		 * superscripted until this method is called again.
		 */
		...
		/**
		 * Turns subscript printing on or off. Subscript printing is initially
		 * off. Text subsequently appended to this object will be subscripted
		 * until this method is called again.
		 */
		...
		/**
		 * Turns outline printing on or off (Macintosh only). Outline printing
		 * is initially off. Text subsequently appended to this object will be
		 * outlined until this method is called again.
		 */
		...
		/**
		 * Turns shadow printing on or off (Macintosh only). Shadow printing is
		 * initially off. Text subsequently appended to this object will be
		 * shadowed until this method is called again.
		 */
		 ...
		 * Previously appended text is not affected.
		 * <p/>
		 * <strong>Note:</strong> no checking is performed to determine if
		 * fontName is a valid font.
		 * 
		 * @param fontName
		 ...
		 * Previously appended text is not affected.
		 * <p/>
		 * Valid point sizes are between 1 and 99 (inclusive). If size is
		 * outside this range, this method returns false and does not change
		 * font size. If size is within this range, the font size is changed and
		 * true is returned.
		 * 
		 * @param size
		 *            The size in points. Valid point sizes are between 1 and 99
		 *            (inclusive).
		 * @return true if the font size was changed, false if font size was not
		 *         changed because 1 > size > 99.
		 */
	...
	/**
	 * Constructor used when reading workbooks to separate the left, right a
	 * central part of the strings into their constituent parts
	 */
	protected HeaderFooter(String s) {
		...
		if (leftPos == -1 && rightPos == -1 && centrePos == -1) {
			...
			if (centrePos != -1) {
				...
				centre = createContents(s
						.substring(centrePos + 2, endCentrePos));
			}
		}
