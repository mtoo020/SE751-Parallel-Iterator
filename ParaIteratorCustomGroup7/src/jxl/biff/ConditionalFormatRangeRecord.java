...
public class ConditionalFormatRangeRecord extends WritableRecordData {
	...
	private static Logger logger = Logger
			.getLogger(ConditionalFormatRangeRecord.class);
	...
	private static class Range {
		...
		/**
		 * Removes a row from this spreadsheet. If the row is out of range of
	...
	private void initialize() {
		...
		for (int i = 0; i < numRanges; i++) {
			...
			ranges[i].lastRow = IntegerHelper.getInt(data[pos + 2],
					data[pos + 3]);
			ranges[i].firstColumn = IntegerHelper.getInt(data[pos + 4],
					data[pos + 5]);
			ranges[i].lastColumn = IntegerHelper.getInt(data[pos + 6],
					data[pos + 7]);
			pos += 8;
		}
