...
/**
 * The excel string for the various built in formats. Used to present the cell
 * format information back to the user
 *
 * The difference between this class and the various format object contained in
 * the jxl.write package is that this object contains the Excel strings, not
...
final class BuiltInFormat implements Format, DisplayFormat {
	...
	/**
	 * Accesses the excel format string which is applied to the cell Note that
	 * this is the string that excel uses, and not the java equivalent
	 *
	 ...
	 *
	 * @param pos
	 *            the position of this format record in the workbook
	 */
