...
public interface WritableCell extends Cell {
	...
	/**
	 * A deep copy. The returned cell still needs to be added to the sheet. By
	 * not automatically adding the cell to the sheet, the client program may
	 * change certain attributes, such as the value or the format
	 *
	 * @param col
