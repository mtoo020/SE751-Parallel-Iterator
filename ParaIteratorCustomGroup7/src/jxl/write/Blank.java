...
/**
 * A blank cell. Despite not having any contents, it may contain formatting
 * information. Such cells are typically used when creating templates
 */
public class Blank extends BlankRecord implements WritableCell {
	...
	/**
	 * Creates a cell which, when added to the sheet, will be presented at the
	 * specified column and row co-ordinates in the manner specified by the
	 * CellFormat parameter
	 *
	 * @param c
	 *            the column
	 * @param r
