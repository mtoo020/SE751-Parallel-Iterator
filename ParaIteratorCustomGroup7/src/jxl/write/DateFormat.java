 ...
 * format. The string format used to create a DateFormat adheres to the standard
 * java specification, and JExcelApi makes the necessary modifications so that
 * it is rendered as its nearest equivalent in Excel. Once created, this may be
 * used within a CellFormat object, which in turn is a parameter passed to the
 * constructor of the DateTime cell
 */
