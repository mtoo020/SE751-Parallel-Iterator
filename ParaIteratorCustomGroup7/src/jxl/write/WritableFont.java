...
/**
 * A class which is instantiated when the user application wishes to specify the
 * font for a particular cell
 */
public class WritableFont extends WritableFontRecord {
	...
	public WritableFont(FontName fn) {
		this(fn, DEFAULT_POINT_SIZE, NO_BOLD, false,
	...
	public WritableFont(FontName fn, int ps) {
		this(fn, ps, NO_BOLD, false, UnderlineStyle.NO_UNDERLINE, Colour.BLACK,
				ScriptStyle.NORMAL_SCRIPT);
	}
	...
	public WritableFont(FontName fn, int ps, BoldStyle bs) {
		this(fn, ps, bs, false, UnderlineStyle.NO_UNDERLINE, Colour.BLACK,
				ScriptStyle.NORMAL_SCRIPT);
	}
	...
	public WritableFont(FontName fn, int ps, BoldStyle bs, boolean italic) {
		this(fn, ps, bs, italic, UnderlineStyle.NO_UNDERLINE, Colour.BLACK,
				ScriptStyle.NORMAL_SCRIPT);
	}
	 ...
	 */
	public WritableFont(FontName fn, int ps, BoldStyle bs, boolean it,
			UnderlineStyle us, Colour c) {
		this(fn, ps, bs, it, us, c, ScriptStyle.NORMAL_SCRIPT);
	}

	/**
	 * Creates a font of the specified face, point size, bold style,
	 * italicisation, underline style, colour, and script style
	 ...
	 */
	public WritableFont(FontName fn, int ps, BoldStyle bs, boolean it,
			UnderlineStyle us, Colour c, ScriptStyle ss) {
		super(fn.name, ps, bs.value, it, us.getValue(), c.getValue(), ss
				.getValue());
	}
	...
	/**
	 * Sets the script style (eg. superscript, subscript) for this font, if the
	 * font hasn't been initialized
	 *
	 * @param scriptStyle
	 *            the colour
	 * @exception WriteException
	...
	/**
	 * Factory method which creates the specified font name. This method should
	 * be used with care, since the string used to create the font name must be
	 * recognized by Excel's internal processing
	 *
	 * @param fontName
