...
/**
 * A cell, created by user applications, which contains a boolean (or in some
 * cases an error) value
 */
public class Boolean extends BooleanRecord implements WritableCell, BooleanCell {
	...
	/**
	 * Constructs a boolean, which, when added to a spreadsheet, will display
	 * the specified value at the column/row position with the specified
	 * CellFormat. The CellFormat may specify font information
	 *
	 * @param c
	 *            the column
	 * @param r
