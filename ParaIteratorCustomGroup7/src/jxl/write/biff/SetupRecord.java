...
class SetupRecord extends WritableRecordData {
	...
	/**
	 * Indicates whether the setup data should be initiliazed in the setup box
	 */
	private boolean initialized;

	/**
	 * Constructor, taking the sheet settings. This object just takes the
	 * various fields from the bean in which it is interested
	 * 
	 * @param the
	 *            sheet settings
	 */
