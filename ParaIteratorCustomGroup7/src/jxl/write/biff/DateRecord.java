...
public abstract class DateRecord extends CellValue {
   ...
   */
	...
	/**
	 * This is package protected so that the worksheet might detect whether or
	 * not to override it with the column cell format
	 */
	static final WritableCellFormat defaultDateFormat = new WritableCellFormat(
			DateFormats.DEFAULT);
   ...
   */
	 ...
	 *
	 * @param adjust
	 *            TRUE if we want to incorporate timezone information into the
	 *            raw UTC date eg. when copying from a spreadsheet
	 */
	 ...
	 * or merely a time. When writing a cell, all dates are fully defined, even
	 * if they refer to a time
	 * 
