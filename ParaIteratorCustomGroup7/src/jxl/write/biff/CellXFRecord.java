...
public class CellXFRecord extends XFRecord {
	...
	/**
	 * Sets the text wrapping for cells with this style. If the parameter is set
	 * to TRUE, then data in this cell will be wrapped around, and the cell's
	 ...
	 *            the border
	 * @param ls
	 *            the line for the specified border
	 */
