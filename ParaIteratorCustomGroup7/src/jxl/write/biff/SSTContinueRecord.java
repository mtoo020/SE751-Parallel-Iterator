...
class SSTContinueRecord extends WritableRecordData {
	...
	/**
	 * Indicates whether or not we need to include the length information for
	 * the first string
	 */
	 ...
	 *            the string to add
	 * @param b
	 *            include the length information for the first string
	...
	/**
	 * Adds a string to this record. It returns the number of string characters
	 * not added, due to space constraints. In the event of this being non-zero,
	 * a continue record will be needed
	 *
	 * @param s
	 *            the string to add
	 * @return the number of characters not added
