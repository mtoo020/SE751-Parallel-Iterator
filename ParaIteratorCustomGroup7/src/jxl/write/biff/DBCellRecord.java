...
/**
 * Indexes the first row record of the block and each individual cell. This is
 * invoked by the sheets write process
 */
class DBCellRecord extends WritableRecordData {
	...
	/**
	 * The position of the start of the next cell after the first row. This is
	 * used as the offset for the cell positions
	 */
