...
class ColumnInfoRecord extends WritableRecordData {
	...
	/**
	 * Copy constructor used when copying from sheet to sheet within the same
	 * workbook
	 *
	 * @param the
	 *            record to copy
	 ...
	 *            the column number
	 * @param cir
	 *            the column info record read in
	 * @param fr
	 *            the format records
	 */
	...
	/**
	 * Constructor used when importing a sheet from another spreadsheet
	 * 
	 * @param col
	 *            the column number
	 * @param cir
	 ...
	 *
	 * @param h
	 *            TRUE if the column is to be hidden, FALSE otherwise
	 */
	...
	public boolean equals(Object o) {
		...
		if (column != cir.column || xfIndex != cir.xfIndex
				|| width != cir.width || hidden != cir.hidden
				|| outlineLevel != cir.outlineLevel
				|| collapsed != cir.collapsed) {
			return false;
		}
	...
	/**
	 * Increments the column's outline level. This is how groups are made as
	 * well
	 */
	...
	/**
	 * Decrements the column's outline level. This removes it from a grouping
	 * level. If all outline levels are gone the uncollapse the column.
	 */
