 ...
 */
class ReadNumberFormulaRecord extends ReadFormulaRecord implements
		NumberFormulaCell {
	// The logger
	private static Logger logger = Logger
			.getLogger(ReadNumberFormulaRecord.class);
	...
	/**
	 * Error formula specific exception handling. Can't really create a formula
	 * (as it will look for a cell of that name, so just create a STRING record
	...
	protected byte[] handleFormulaException() {
		...
		FormulaParser parser = new FormulaParser(Double.toString(getValue()),
				w, w, w.getSettings());
