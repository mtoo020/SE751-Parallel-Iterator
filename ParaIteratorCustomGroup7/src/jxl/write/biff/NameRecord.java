...
class NameRecord extends WritableRecordData {
	...
	/**
	 * The 0-based index sheet reference for a record name 0 is for a global
	 * reference
	 */
	...
	static class NameRange {
		 ...
		 */
		NameRange(int extSheet, int theStartRow, int theEndRow,
				int theStartCol, int theEndCol) {
	 ...
	 *            Index of this name.
	 * @param extSheet
	 *            External sheet index this name refers to.
	 * @param theStartRow
	 ...
	 */
	NameRecord(String theName, int theIndex, int extSheet, int theStartRow,
			int theEndRow, int theStartCol, int theEndCol, boolean global) {
		super(Type.NAME);

		name = theName;
		index = theIndex;
		sheetRef = global ? 0 : index + 1; // 0 indicates a global name,
											// otherwise
											// the 1-based index of the sheet

		ranges = new NameRange[1];
		ranges[0] = new NameRange(extSheet, theStartRow, theEndRow,
				theStartCol, theEndCol);
		modified = true;
	}
	 ...
	 *            TRUE if this is a global name
	 */
	NameRecord(BuiltInName theName, int theIndex, int extSheet,
			int theStartRow, int theEndRow, int theStartCol, int theEndCol,
			boolean global) {
		super(Type.NAME);
	 ...
	 *            Last column this name refers to.
	 * @param theStartRow2
	 *            First row this name refers to (2nd instance).
	 * @param theEndRow2
	 *            Last row this name refers to (2nd instance).
	 * @param theStartCol2
	 *            First column this name refers to (2nd instance).
	 * @param theEndCol2
	 *            Last column this name refers to (2nd instance).
	 * @param global
	 *            TRUE if this is a global name
	 */
	NameRecord(BuiltInName theName, int theIndex, int extSheet,
			int theStartRow, int theEndRow, int theStartCol, int theEndCol,
			int theStartRow2, int theEndRow2, int theStartCol2, int theEndCol2,
			boolean global) {
		super(Type.NAME);
		...
		ranges[0] = new NameRange(extSheet, theStartRow, theEndRow,
				theStartCol, theEndCol);
		ranges[1] = new NameRange(extSheet, theStartRow2, theEndRow2,
				theStartCol2, theEndCol2);
	}
	...
	/**
	 * Set the index sheet reference for a record name 0 is for a global
	 * reference
	 *
	 */
