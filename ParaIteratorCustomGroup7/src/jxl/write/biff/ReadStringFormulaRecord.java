 ...
 */
class ReadStringFormulaRecord extends ReadFormulaRecord implements
		StringFormulaCell {
	// the logger
	...
	/**
	 * String formula specific exception handling. Can't really create a formula
	...
	protected byte[] handleFormulaException() {
		...
		FormulaParser parser = new FormulaParser("\"" + getContents() + "\"",
				w, w, w.getSettings());
