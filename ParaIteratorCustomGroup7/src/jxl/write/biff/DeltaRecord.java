...
class DeltaRecord extends WritableRecordData {
	...
	public byte[] getData() {
		...
		/*
		 * long val = Double.doubleToLongBits(iterationValue); data[0] = (byte)
		 * (val & 0xff); data[1] = (byte) ((val & 0xff00) >> 8); data[2] =
		 * (byte) ((val & 0xff0000) >> 16); data[3] = (byte) ((val & 0xff000000)
		 * >> 24); data[4] = (byte) ((val & 0xff00000000L) >> 32); data[5] =
		 * (byte) ((val & 0xff0000000000L) >> 40); data[6] = (byte) ((val &
		 * 0xff000000000000L) >> 48); data[7] = (byte) ((val &
