...
/**
 * The name used when Excel was installed. When writing worksheets, it uses the
 * value from the WorkbookSettings object, if this is not set (null) this is
 * hard coded as Java Excel API + Version number
 */
class WriteAccessRecord extends WritableRecordData {
	...
	public WriteAccessRecord(String userName) {
		...
		data = new byte[112];
		String astring = userName != null ? userName : authorString + " v"
				+ Workbook.getVersion();
