...
/**
 * Stores the supporting workbook information. For files written by JExcelApi
 * this will only reference internal sheets
 */
class SupbookRecord extends WritableRecordData {
	 ...
	 *
	 * @param fn
	 *            the filename of the external supbook
	 * @param ws
	 *            the workbook settings
	 */
	...
	/**
	 * Adjust the number of internal sheets. Called by WritableSheet when a
	 * sheet is added or or removed to the workbook
	 *
	 * @param sheets
	 *            the new number of sheets
	 */
	...
	private void initExternal() {
		...
		int dataLength = 2
				+ // numsheets
				4 + fileNameData.length + numSheets * 3 + totalSheetNameLength
				* 2;
	...
	/**
	 * Gets the number of sheets. This will only be non-zero for internal and
	 * external supbooks
	 *
