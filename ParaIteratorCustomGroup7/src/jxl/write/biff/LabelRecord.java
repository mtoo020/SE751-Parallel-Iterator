...
public abstract class LabelRecord extends CellValue {
	...
	/**
	 * Constructor used when creating a label from the API. This is overloaded
	 * to allow formatting information to be passed to the record
	 * 
	 * @param c
	 *            the column
	 * @param cont
	...
	/**
	 * Gets the label for this cell. The value returned will be the same as for
	 * the getContents method in the base class
	 * 
	...
	/**
	 * Overrides the method in the base class in order to add the string content
	 * to the shared string table, and to store its shared string index
	 *
	 * @param fr
