...
class BOFRecord extends WritableRecordData {
	...
	public final static WorkbookGlobalsBOF workbookGlobals = new WorkbookGlobalsBOF();
	 ...
	 *
	 * @param dummy
	 *            - a dummy argument for overloading purposes
	 */
	public BOFRecord(WorkbookGlobalsBOF dummy) {
		...
		// workbook globals
		data = new byte[] { (byte) 0x0, (byte) 0x6, (byte) 0x5, // substream
																// type
	...
	public BOFRecord(SheetBOF dummy) {
		...
		// Create the data as biff 8 format with a substream type of
		// worksheet
		data = new byte[] { (byte) 0x0, (byte) 0x6, (byte) 0x10, // substream
																	// type
				(byte) 0x0, // substream type
				(byte) 0xf2, // rupBuild
				(byte) 0x15, // rupBuild
