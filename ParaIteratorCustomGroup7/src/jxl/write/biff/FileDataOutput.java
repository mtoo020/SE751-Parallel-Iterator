...
/**
 * Used to generate the excel biff data using a temporary file. This class wraps
 * a RandomAccessFile
 */
class FileDataOutput implements ExcelDataOutput {
	 ...
	 *
	 * @param tmpdir
	 *            the temporary directory used to write files. If this is NULL
	 *            then the sytem temporary directory will be used
	 */
	...
	/**
	 * Writes the bytes to the end of the array, growing the array as needs
	 * dictate
	 *
	 * @param d
	 *            the data to write to the end of the array
	 */
	...
	public void close() throws IOException {
		...
		// that a single process may be generating multiple different excel
		// files
