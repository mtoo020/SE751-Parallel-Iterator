...
public class WritableHyperlink extends HyperlinkRecord implements Hyperlink {
	/**
	 * Constructor used internally by the worksheet when making a copy of
	 * worksheet
	 *
	 * @param h
	 *            the hyperlink being read in
	 * @param ws
	 ...
	 *            the row containing this hyperlink
	 * @param desc
	 *            the cell contents for this hyperlink
	 * @param sheet
	 ...
	 */
	public WritableHyperlink(int col, int row, String desc,
			WritableSheet sheet, int destcol, int destrow) {
		this(col, row, col, row, desc, sheet, destcol, destrow, destcol,
				destrow);
	}
	 ...
	 */
	public WritableHyperlink(int col, int row, int lastcol, int lastrow,
			String desc, WritableSheet sheet, int destcol, int destrow,
			int lastdestcol, int lastdestrow) {
		super(col, row, lastcol, lastrow, desc, sheet, destcol, destrow,
	 ...
	 *            the row number of the last destination linked cell
	 */
	public void setLocation(String desc, WritableSheet sheet, int destcol,
			int destrow, int lastdestcol, int lastdestrow) {
		super.setLocation(desc, sheet, destcol, destrow, lastdestcol,
				lastdestrow);
	}
