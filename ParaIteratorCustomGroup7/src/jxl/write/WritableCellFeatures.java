...
public class WritableCellFeatures extends CellFeatures {
	...
	/**
	 * Sets the cell comment and sets the size of the text box (in cells) in
	 * which the comment is displayed
	 *
	 * @param s
	 *            the comment
	 * @param width
	 ...
	 *
	 * @param col1
	 *            the first column containing the data to validate against
	 * @param row1
	 *            the first row containing the data to validate against
	 * @param col2
	 *            the second column containing the data to validate against
	 * @param row2
	...
	/**
	 * Sets the data validation based upon a named range. If the namedRange is
	 * an empty string ("") then the cell is effectively made read only
	 *
	 * @param namedRange
