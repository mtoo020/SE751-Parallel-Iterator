 ...
 */
public class DynamicBFSonDAGBottomTopWorkStealing<V> extends
		ParIteratorAbstract<V> {
	...
	// Keep track of nodes stolen. Can be used to prevent stolen nodes from
	// taken back by original owner thread.
