...
public abstract class ParIteratorAbstract<E> implements ParIterator<E> {
	...
	public ParIteratorAbstract(Collection<E> collection, int chunkSize,
	...
	public void remove() {
		throw new UnsupportedOperationException(
				"This Parallel Iterator currently does not support remove()");
	}
	...
	public void register(Exception e, E currentElements) {
		...
		ParIteratorException<E> pie = PIExceptionHelper.createException(e,
				currentElements, regThread);
		exceptions.add(pie);
	}
	...
	// for test
	public int getID() {
		// TODO the thread ID thing need to be redesigned because of the reset
		// feature.
